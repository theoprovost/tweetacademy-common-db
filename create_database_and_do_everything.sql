...
CREATE TABLE messages (
    ...
    addressee BIGINT NOT NULL REFERENCES tweets(id) ON DELETE CASCADE,
    title VARCHAR(255) NULL,
    content TEXT NULL,

    read_at TIMESTAMP NULL ON UPDATE CURRENT_TIMESTAMP,
...
ADD telephone VARCHAR(255) NULL,
ADD city VARCHAR(255) NULL,
ADD country VARCHAR(255) NULL,
ADD biography VARCHAR(255) NULL;

CREATE TABLE notifications (
    id BINARY(16) PRIMARY KEY NOT NULL UNIQUE DEFAULT (UUID_TO_BIN(UUID())), -- uuid
